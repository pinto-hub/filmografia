...
<body>
	...
	<div
		...
		<div>
		<a class="btn btn-danger mr-3" href="paginaDirectores">Finalizar</a>
	...
	<div
		...
		<f:form class="d-flex align-items-center" action="consultaDirector"
			method="POST">
			<input type="submit" class="btn btn-success text-light"
				value="Buscar Pelicula:" />
			<input type="text" placeholder="Introduce el director" name="director"
