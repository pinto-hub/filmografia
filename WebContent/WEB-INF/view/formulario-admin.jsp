...
<body>
	<div class="container bg-dark text-light p-4 col-12 d-flex justify-content-between align-items-center">
		<h2>Admin: ${adminName.name}</h2>
		<a class="btn btn-primary" href="paginaAdmin">Volver</a>
	</div>
	
	<div class="container pt-5">
		<f:form class="pt-3" action="guardarAdmin"
			...
			<div class="form-group d-flex flex-column">
				...
				<f:input maxlength="45" class="ml-3 mr-3" path="name"></f:input>				
				</div>
			</div>
			<div class="form-group d-flex flex-column">
				<label>Contraseña:</label>
				<div class="d-flex align-items-center">
				<f:input maxlength="45" class="ml-3 mr-3" path="password"></f:input>				
				</div>
			</div>

			<input class="btn btn-success mt-3" type="submit" value="Guardar Admin">
